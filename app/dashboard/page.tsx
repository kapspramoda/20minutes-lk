      ...
      <header className="sticky top-0 z-50 flex justify-between items-center p-4 md:px-8 bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-100">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-red-50 hover:bg-red-500 text-red-600 hover:text-white text-sm font-semibold rounded-lg transition-all shadow-sm border border-red-100"
          >
            ඉවත් වන්න
          </button>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {myCourses.map((course) => (
              <div key={course.id} className="overflow-hidden rounded-2xl bg-white shadow-sm transition hover:shadow-md border border-slate-100 hover:-translate-y-1 duration-300">
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-bold text-white tracking-tight logo-font">20minutes.lk</h2>
            </div>
            <p className="text-sm text-slate-400">ඔබේ විභාග ජයග්‍රහණය වෙනුවෙන් සැකසුණු සාර්ථකම මාර්ගගත ඉගෙනුම් වේදිකාව.</p>
          </div>
          <div>
            <h3 className="text-white font-bold mb-4">සබැඳි (Links)</h3>
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-blue-400 transition">මුල් පිටුව</a></li>
              <li><a href="#" className="hover:text-blue-400 transition">අප ගැන</a></li>
              <li><a href="#" className="hover:text-blue-400 transition">පාඨමාලා</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-white font-bold mb-4">විමසීම්</h3>
            <ul className="space-y-2 text-sm">
              <li>📞 07X XXX XXXX</li>
              <li>✉️ info@20minutes.lk</li>
            </ul>
          </div>
        </div>
        <div className="max-w-6xl mx-auto px-6 mt-8 pt-6 border-t border-slate-800 text-center text-xs text-slate-500">
